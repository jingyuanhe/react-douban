...
const baseUri = 'https://douban.uieee.com/v2/movie';
export default class SeekTv extends Component{
    constructor(props) {
        super(props)
        this.state = {
          ready: true,
    ...
    render(){
        ...
        return(
            <ScrollView>
                {
                    this.state.ready?<ActivityIndicator  size="large" style={styles.loadding}></ActivityIndicator>:
